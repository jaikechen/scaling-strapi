...
module.exports = {
  async find(ctx) {
    ...
    //jackie: apply account id filter
    permissionQuery.filters = {...permissionQuery.filters, aid: ctx.state.user.aid}
  ...
  async create(ctx) {
    ...
    //jackie: apply account id
    sanitizedBody.aid = ctx.state.user.aid
  ...
  async update(ctx) {
    ...
    //jackie apply account id
    if (entity.aid !== ctx.state.user.aid){
      return ctx.forbidden();
    }
  ...
  async publish(ctx) {
    ...
    //jackie apply account id
    if (entity.aid !== context.state.user.aid){
      return ctx.forbidden();
    }
  ...
  async bulkDelete(ctx) {
    ...
    permissionQuery.filters = {...permissionQuery.filter, aid: ctx.state.user.aid}
